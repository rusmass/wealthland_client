...
namespace Client.UI
{
	public partial class UIRegistWindow
	{
...
//			}
		...
		private void _onBtnSureHandler(GameObject go)
		{
			...
			Console.WriteLine ("jsonString:"+tmpG);
				...
				Console.WriteLine ("注册啦啦啦啦啦啦啦啦");
//				backdata = HttpRequestHelp.GetInstance ().GetRegistData (tmpG);
				HttpRequestManager.GetInstance().GetRegistData (tmpG,_HandlerSuccess);
...
//			}
		...
		private void _HandlerSuccess()
		{
            ...
            //Console.Error.WriteLine("注册成功啦啦啦啦");
...
//			}
		...
		private void _SetSureBtnWord()
		{
			...
			btn_sureModify.SetActiveEx (false);
		}
