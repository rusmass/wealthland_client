...
namespace Client.UI
{
    ...
    /// 修改密码界面
    /// </summary>
	public class UIModifyWindowController:UIController<UIModifyWindow,UIModifyWindowController>
	{
		public UIModifyWindowController ()
		{
		}
		...
		private void _HideTimeUI()
		{
			...
			{
				(_window as UIModifyWindow).HideTimeCount ();
			}
		}
		...
		private void _ShowTimeUI()
		{
			if (null != _window && getVisible ())
			{
				(_window as UIModifyWindow).ShowTimeCount ();
			}
		}
		...
		private void _UpdateTimeUI(string value)
		{
			if (null != _window && getVisible ())
			{
				(_window as UIModifyWindow).UpdateTimeNum(value);
			}
		}
