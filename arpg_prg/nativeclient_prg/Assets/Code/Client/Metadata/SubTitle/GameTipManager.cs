...
namespace Client
{
    ...
    public class GameTipManager
	{
        ...
        /// </summary>
        /// <returns></returns>
        public string GetRandomRiskFrustration()
        {
            var tmpStr = "";
            var tmpNum = MathUtility.Random(0,100);

            if(tmpNum>50)
            {
                tmpStr = _gameTips.overOuterCardRisk;
            }
            else
            {
                tmpStr = _gameTips.overOuterCardRisk2;
            }                       
            return tmpStr;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public string GetRandomRiskLoss()
        {
            var tmpStr = "";
            var tmpNum = MathUtility.Random(0, 100);
            if (tmpNum > 50)
            {
                tmpStr = _gameTips.overOuterCardRisk3;
            }
            else
            {
                tmpStr = _gameTips.overOuterCardRisk4;
            }
            return tmpStr;
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns></returns>
        public string GetRandomRiskNormal()
        {
            var tmpStr = "";
            var tmpNum = MathUtility.Random(0, 100);
            if (tmpNum > 50)
            {
                tmpStr = _gameTips.overOuterCardRisk5;
            }
            else
            {
                tmpStr = _gameTips.overOuterCardRisk6;
            }
            return tmpStr;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public string GetRandomInnerFate()
        {
            var tmpStr = "";            
            ...
            if (tmpNum >= 75)
            {
                tmpStr = _gameTips.overInnerFate;
            }
            else if (tmpNum >= 50)
            {
                tmpStr = _gameTips.overInnerFate2;
            }
            else if (tmpNum > 25)
            {
                tmpStr = _gameTips.overInnerFate3;
            }
            else
            {
                tmpStr = _gameTips.overInnerFate4;
            }
            return tmpStr;
        }
        ...
        public string GetRandomCare()
        {
            ...
            if (tmpNum >= 66)
            {
                tmpStr = _gameTips.innerCareEffect1;
            }
            else if (tmpNum >= 33)
            {
                tmpStr = _gameTips.innerCardEffect2;
            }
            else 
            {
                tmpStr = _gameTips.innerCardEffect3;
            }
...
//			tmpVlaue=this.GetType ().GetField ("tip3").GetValue (this).ToString ();
        ...
        /// <summary>
        /// Gets the star tip for pinzhi. 运用财富的评价话术 ， 用过星级获得(品质指数)
        /// </summary>
        ...
        /// <summary>
        /// Gets the star tip for chengzhang. 超越财富的评价话术 ， 用过星级获得(成长指数)
        /// </summary>
        /// <param name="index">Index.</param>
        ...
        /// <summary>
        /// Gets the star tip for caishang. 创造财富的评价话术 ， 用过星级获得（财商指数）
        /// </summary>
        /// <param name="index">Index.</param>
        ...
        /// <summary>
        /// Gets the star tip for fengxian. 管理财富的评价话术 ， 用过星级获得（抗风险指数）
        /// </summary>
        /// <param name="index">Index.</param>
