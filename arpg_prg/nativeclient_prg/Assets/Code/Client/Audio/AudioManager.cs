...
namespace Audio
{
    ...
    public partial class AudioManager
	{
		...
		#region 播放音乐
		public void Play(string audioPath ,bool mLoop=true)
		{
            //if(audioPath== "share/audio/youxi3.ab")
            //{
            //    Console.Error.WriteLine("播放挡墙的开始的音乐了");
            //}
            ...
            //if (null != _audio &&  !_audio.isPlaying && null!= _audio.clip  && _audio.clip.name == audioPath)
            //{
            //    //if()                
            //    _audio.Play();
            //    return;
		...
		public void Stop()
		{
            ...
            _audio.Pause();
            _audio.clip = null;
            //Console.Warning.WriteLine("停止播放音乐-----------");
        }
		...
		{            
            ...
            //}
            var tmpPlayer = Client.PlayerManager.Instance.HostPlayerInfo;
            if (null!=tmpPlayer)
            {
                if(tmpPlayer.GameProgress<0.6)
                {
                    tmpPath = subTitleManager.musicData.backGroundAndio;
                }
                else if(tmpPlayer.GameProgress < 1)
                {
                    tmpPath = subTitleManager.musicData.bgNewAdd3;
                }
                else if(tmpPlayer.GameProgress<3.5)
                {
                    tmpPath = subTitleManager.musicData.bgNewAdd1;
                }
                else
