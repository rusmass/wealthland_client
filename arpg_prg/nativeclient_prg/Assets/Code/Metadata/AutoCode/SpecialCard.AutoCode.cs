...
{
    [Serializable]
    sealed partial class SpecialCard : ILoadable
#if UNITY_EDITOR
    , ISavable
#endif
    {
        ...
        {
            return string.Format("[SpecialCard:ToString()] id={0}, title={1}, desc={2}, cardPath={3}, rankScore={4}, quitScore={5}", id, title, desc, cardPath, rankScore, quitScore);
        }
        [Export(ExportFlags.AutoCode)]
