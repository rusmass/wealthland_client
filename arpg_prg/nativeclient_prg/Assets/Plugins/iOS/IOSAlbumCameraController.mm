...
- (void)imagePickerController:(UIImagePickerController*)picker didFinishPickingMediaWithInfo:(NSDictionary*)info
{
    ...
    UnitySendMessage( "personalcenter", "PickImageCallBack_Base64", _encodeImageStr.UTF8String);
...
+(void) image:(UIImage*)image didFinishSavingWithError:(NSError*)error contextInfo:(void*)contextInfo
{
    ...
    UnitySendMessage( "personalcenter", "SaveImageToPhotosAlbumCallBack", result.UTF8String);
}
...
extern "C" {
    ...
    void _iosOpenPhotoLibrary()
    {
        ...
        {
            UnitySendMessage( "personalcenter", "PickImageCallBack_Base64", (@"").UTF8String);
        }
    }
