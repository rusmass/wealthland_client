...
//			_controller.UpdateChatData (chatvo);
		...
		private void _OnOpenBoard(GameObject go)
		{
//			UIBattleController.isOpenRecordWindow = true;
//			btn_open.SetActiveEx (false);
//			btn_open.transform.SetParent(bgTransform);
//			var quance = DOTween.Sequence ();
//			quance.Append (bgTransform.DOScale(Vector3.one,0.5f));
//			quance.AppendCallback (()=>{
//				btn_close.SetActiveEx(true);
//				btn_close.transform.localScale=Vector3.one;
//			});
		}
