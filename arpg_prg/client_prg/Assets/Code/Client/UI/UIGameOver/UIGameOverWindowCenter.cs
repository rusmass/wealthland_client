...
//			_imgSun = go.GetComponentEx<Animator> (Layout.animation_sun);
		...
		private void _OnShowCenter()
		{
            ...
            {
                GameModel.GetInstance.IsPlayingGame = GamePlayingState.GameOverNetState;
            }
            else
            {
                GameModel.GetInstance.IsPlayingGame = GamePlayingState.GameOverSigleState;
            }
...
//					if (null != img_wintor)
//					{
//						var tmpPosition = img_wintor.transform.localPosition;
//						img_wintor.transform.localPosition = new Vector3 (_positionX[i],tmpPosition.y,tmpPosition.z);					
//					}
				}
				else
				{
...
//		private Image img_wintor;
		...
		private float[] _positionX={-354f,-136f,358f,-336f,336f};
