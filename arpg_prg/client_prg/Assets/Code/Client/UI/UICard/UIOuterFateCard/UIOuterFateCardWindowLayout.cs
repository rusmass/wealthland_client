...
namespace Client.UI
{
	public partial class UIOuterFateCardWindow
	{
		class Layout
		{
			...
			public static string lb_cardname="toptitle/lbcardname";
...
//			public static string lb_desc3="center/wordbg/ScrollView/ViewPort/Content/desc3Name";
			...
			public static string lb_salenametxt="salenameitem";

			// 提示没有更多
			public static string lb_noConditiionTip="noconditiontip";

			public static string btn_close="btnclosesale";
			public static string lb_saletotal="saletotalmoney";
			public static string lb_saleimcone="saleincome";
			public static string lb_quality="salequalityd";
			public static string btn_salesure="suresalebtn";
			...
			// 前面板的容器
			public static string transform_normal="normalboard";
		}
