...
namespace Metadata
{
	...
	public partial class PlayerInitData:Template
	{
		...
		/// </summary>
		public int fixHouseMortgages=0;
		/// <summary>
		/// The fix education loan. 教育贷款 用于展示
		/// </summary>
		public int fixEducationLoan=0;
		/// <summary>
		/// The fix car loan. 购车贷款 用于展示
		/// </summary>
		public int fixCarLoan=0;
		/// <summary>
		...
		/// </summary>
		public int houseMortgages=0;
		/// <summary>
		/// The education loan. 每月要还的教育贷款
		/// </summary>
		public int educationLoan=0;
		/// <summary>
		/// The car loan. 每月要偿还的购车贷款
		/// </summary>
		public int carLoan=0;
		/// <summary>
		...
		/// </summary>
		public int additionalDebt=0;
		/// <summary>
		/// The other spend. 其它支出 
		/// </summary>
		public int otherSpend=0;
		/// <summary>
		/// The infor. 信息简介
		/// </summary>
		public string infor;
